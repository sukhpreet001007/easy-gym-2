...
//                 scale: 1.00,
//                 scaleMobile: 1.00,
//                 backgroundColor: 0x140178, // Match your dark blue color
//                 color1: 0xFFDD33, // Golden color for birds
//                 color2: 0x1E59FF, // Blue color for birds
//                 birdSize: 0.70,
//                 wingSpan: 17.00,
//                 speedLimit: 3.00,
//                 separation: 67.00,
//                 alignment: 60.00,
//                 cohesion: 53.00,
//                 backgroundAlpha: 0.7 // Slight transparency
//             });
//         }
//     }
...
//     // Create sparkle particles (kept from previous implementation)
//     const fullSection = document.querySelector('.full-w-section');
//     if (fullSection) {
//         const sparkleContainer = document.createElement('div');
//         sparkleContainer.className = 'sparkle-container';
//         fullSection.appendChild(sparkleContainer);

//         // Create energy orbs
//         const orb1 = document.createElement('div');
//         orb1.className = 'energy-orb gold';
//         orb1.style.left = '10%';
//         orb1.style.top = '20%';
//         orb1.style.animationDelay = '0s';
//         sparkleContainer.appendChild(orb1);

//         const orb2 = document.createElement('div');
//         orb2.className = 'energy-orb blue';
//         orb2.style.left = '80%';
//         orb2.style.top = '70%';
//         orb2.style.animationDelay = '5s';
//         sparkleContainer.appendChild(orb2);

//         // Create sparkle particles
//         const sparkleTypes = ['tiny', 'small', 'medium'];
//         const sparkleColors = ['golden', 'blue', 'silver'];
//         const animations = ['sparkleFloat', 'sparkleTwinkle', 'sparkleDrift'];

//         for (let i = 0; i < 20; i++) { // Reduced count for better performance with Vanta.js
...
//             sparkle.style.animation = `${animation} ${3 + Math.random() * 4}s ease-in-out infinite`;
